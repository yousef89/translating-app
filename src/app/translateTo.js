...
export default function TranslateTo({
  ...
  return (
    ...
    <div className="z-10 relative font-dm-sans font-semibold flex flex-col justify-center items-center bg-[#121826cc] rounded-[20px] bg-opacity-5 min-w-[360px] lg:w-[450px] xl:w-[650px]">
      <div className="flex items-center justify-center pt-7 pl-7 mr-auto">
        <div className="flex text-[15px] text-[#626874] gap-x-[5px]  text-opacity-70 mr-auto">
          {languages.slice(0, 3).map((lang) => (
            <button
              key={lang.code}
              onClick={() => setSecLanguage(lang.code)}
              className={
                secLanguage === lang.code
        ...
        {other2 && (
          <div className={`z-10 absolute top-[18%] right-[2%] lg:right-[7%] xl:right-[35%] text-[11px]  bg-gray-800 text-[#f4f6f8] p-2 rounded-md shadow-lg transition-opacity duration-5000 ease-in-out ${other2 ? "opacity-100" : "opacity-0"}`}>
      ...
      <textarea
        className="w-[80%] text-[#F1F2F3] border-none outline-none text-opacity-80 bg-[#121826] pt-[15px] pb-[124px] mx-7 mr-auto rounded-md bg-opacity-0 resize-none"
        value={
        ...
        rows={4}
      />
      <div className="flex items-center justify-center px-5 pb-6 mr-auto">
