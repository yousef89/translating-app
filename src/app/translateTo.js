    ...
    return (
      <div className="w-[560px] z-10 font-dm-sans font-semibold flex flex-col justify-center items-center bg-[#121826cc] rounded-[20px] bg-opacity-5">
        ...
        <div className="flex items-center justify-center pt-7 pl-7 w-[550px]">
            <div className="flex text-[#626874] gap-x-6  text-opacity-70 mr-auto">
            ...
            <div className="flex border-[2px] border-gray-600 border-opacity-40 p-[4px] rounded-[6px] mr-8">
        ...
        <div className="flex items-center justify-center px-5 pb-6 w-[550px]">
          <div className="flex gap-x-2 mr-auto">
            <div className="flex border-[2px] border-gray-600 border-opacity-40 p-[4px] rounded-[6px]">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="flex items-center border-[2px] border-gray-600 border-opacity-40 p-[4px] rounded-[6px]">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
